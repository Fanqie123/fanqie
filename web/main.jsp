...
<body style="background-image: url(img/crossword.png)">
...
<div class="container-fluid">
    <div class="col-sm-3 col-md-2 sidebar" style="background-image: url(img/skulls.png);">
        <ul class="nav nav-sidebar" id="sidebar">
            <li class="active" value="0"><a href="#">房间查询</a></li>
            <li value="1" id="list_order"><a href="#">预定房间</a></li>
            <li value="2"><a href="#">我的订单</a></li>
            <li value="3"><a href="#">个人信息</a></li>
        </ul>
    </div>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="container3" style="display: none">
        ...
        <form class="form-horizontal" role="form" method="post" style="margin: 60px auto;width: 500px;"
              action="signup">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control col-sm-10" id="account" name="account"
                           placeholder="请输入账号" disabled required>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control col-sm-10" id="password"
                           name="password1" placeholder="请输入密码" required disabled>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control col-sm-10" id="name"
                           name="name" placeholder="请输入姓名" required disabled>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control col-sm-10" id="id"
                           name="id" placeholder="请输入身份证号码" required disabled>
                </div>
            </div>
            <div class="form-group">
                <label for="sex1" class="col-sm-2 control-label">性别</label>

                <div class="col-sm-10" style="margin-top: 1px" aria-disabled="false">
                    <label for="sex1" class="control-label">男</label><input type="radio" name="sex" value="男" id="sex1">
                    <label for="sex2" class="control-label">女</label><input type="radio" name="sex" value="女" id="sex2">
                </div>
            </div>

            <button type="submit" class="btn btn-primary col-sm-4" style="float:right">注册</button>
        </form>
    </div>
</div>
